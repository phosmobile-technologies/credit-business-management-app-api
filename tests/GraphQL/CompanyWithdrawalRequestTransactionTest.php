...
class CompanyWithdrawalRequestTransactionTest extends TestCase
{
     ...
     * @test
     */
    public function testItCorrectlyInitiatesANewCompanyWithdrawalRequestTransaction()
    {
        ...
        $transactionData = $this->makeTransaction(TransactionOwnerType::COMPANY_BRANCH, $branch->id, [
            'transaction_type' => TransactionType::COMPANY_WITHDRAWAL
        ]);
     ...
     * @test
     */
    public function testItCorrectlyApprovesACompanyWithdrawalRequestTransaction()
    {
     ...
     * @test
     */
    public function testItCorrectlyDisapprovesACompanyWithdrawalRequestTransaction()
    {
        $this->loginTestUserAndGetAuthHeaders([UserRoles::BRANCH_ACCOUNTANT]);
