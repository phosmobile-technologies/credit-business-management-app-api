...
class CustomerWithdrawalRequestService
{
     ...
     */
    public function __construct(CustomerWithdrawalRequestRepositoryInterface $customerwithdrawalrequestRepository, TransactionService $trService, UserRepositoryInterface $userRepository)
    {
