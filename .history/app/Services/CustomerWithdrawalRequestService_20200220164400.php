...
class CustomerWithdrawalRequestService
{
     ...
     */
    public function __construct(CustomerWithdrawalRequestRepositoryInterface $customerwithdrawalrequestRepository, CustomerWithdrawalRequestService $customerwithdrawalrequestService, UserRepositoryInterface $userRepository)
    {
    ...
    {
        $createcustomerwithdrawalrequestData = [
            'request_id' => $ownerId,
        ...
        $customerwithdrawalrequest = $this->customerwithdrawalrequestRepository->create($createcustomerwithdrawalrequestData);
        ...
        DB::transaction(function () use ($customerwithdrawalrequest, $type, $user, $message) {
            switch ($type) {
                case TransactionProcessingActions::APPROVE:
                    ...
                    $this->transactionRepository->updateRequestStatus($customerwithdrawalrequest, RequestStatus::COMPLETED);
                    break;

                case TransactionProcessingActions::DISAPPROVE:
                    $this->transactionRepository->updateRequestStatus($customerwithdrawalrequest, RequestStatus::FAILED);
                    break;
            }
