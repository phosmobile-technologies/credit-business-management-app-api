...
class CustomerWithdrawalRequestService
{
     ...
     */
    private $CustomerWithdrawalService;
     ...
     */
    public function __construct(CustomerWithdrawalRequestRepositoryInterface $customerwithdrawalrequestRepository, CustomerWithdrawalRequestService $customerWithdrawalRequestService, TransactionService $transactionService, UserRepositoryInterface $userRepository)
    {
