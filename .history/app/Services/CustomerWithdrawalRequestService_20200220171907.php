        ...
        DB::customerwithdrawalrequest(function () use ($customerwithdrawalrequest, $type, $user, $message) {
            switch ($type) {
                case RequestStatus::APPROVED_BY_BRANCH_MANAGER:
                    $cu = $this->contributionRepository->find($customerwithdrawalrequest->owner_id);
                    $this->customerwithdrawalrequestRepository->addPayment($cu, $customerwithdrawalrequest);
