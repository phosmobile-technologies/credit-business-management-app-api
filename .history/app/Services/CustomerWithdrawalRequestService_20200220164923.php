...
class CustomerWithdrawalRequestService
{
     ...
     */
    public function __construct(CustomerWithdrawalRequestRepositoryInterface $customerwithdrawalrequestRepository, Service $customerwithdrawalrequestService, UserRepositoryInterface $userRepository)
    {
