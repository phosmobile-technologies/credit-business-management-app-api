...
class CustomerWithdrawalRequestService
{
     ...
     */
    public function __construct(CustomerWithdrawalRequestRepositoryInterface $customerwithdrawalrequestRepository, TraService $customerwithdrawalrequestService, UserRepositoryInterface $userRepository)
    {
