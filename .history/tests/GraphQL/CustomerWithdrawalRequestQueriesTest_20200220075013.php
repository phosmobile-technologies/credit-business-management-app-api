...
class CustomerWithdrawalRequestQueriesTest extends TestCase
{
    ...
    public function testGetCustomerWithdrawalRequestByIdQuery()
    {
        ...
        $testCustomerWithdrawalRequestByIDs = $this->createTestCustomerWithdrawalRequest($testUser, 3)->toArray();
        ...
        $response->assertJson([
            'data' => [
                'GetCustomerWithdrawalRequestById' => [
                    'id' => $testUser->id,
                    'CustomerWithdrawalRequestByIDs' => [
                        ['id' => $testCustomerWithdrawalRequestByIDs[0]['id']],
                        ['id' => $testCustomerWithdrawalRequestByIDs[1]['id']],
                        ['id' => $testCustomerWithdrawalRequestByIDs[2]['id']],
                    ]
                ]
            ]
        ]);
