...
class CustomerWithdrawalRequestQueriesTest extends TestCase
{
    ...
    public function testGetCustomerWithdrawalRequestByIdQuery()
    {
        ...
        $TestCustomerWithdrawalRequest= $this->createTestCustomerWithdrawalRequest();
        $testcustomerwithdrawalrequests = $this->createTestCustomerWithdrawalRequest($testTestCustomerWithdrawalRequest, 3)->toArray();
