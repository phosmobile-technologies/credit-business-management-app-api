...
class CustomerWithdrawalRequestServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->customerwithdrawalrequestService = Mockery::mock(CustomerWithdrawalRequestService::class);

        $this->app->instance(CustomerWithdrawalRequestRepository::class, $this->customerwithdrawalrequestRepository);
        $this->app->instance(CustomerWithdrawalRequestService::class, $this->customerwithdrawalrequestService);
    ...
    public function testItCorrectlyInitiatesACustomerWithdrawalRequestRepayment()
    {
        ...
        $this->customerwithdrawalrequestService->shouldReceive('initiateCustomerWithdrawalRequestRepaymentTransaction')
            ->andReturnUsing(function ($customerwithdrawalrequestArgument, $customerwithdrawalrequestDetailsArgument) use ($customerwithdrawalrequest, $customerwithdrawalrequestDetails) {
