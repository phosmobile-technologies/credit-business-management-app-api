...
class CustomerWithdrawalRequestServiceTest extends TestCase
{
    ...
    public function testItCorrectlyInitiatesACustomerWithdrawalRequestRepayment()
    {
        ...
        $this->customerwithdrawalrequestService->shouldReceive('initiateCustomerWithdrawalRequestRepaymentTransaction')
            ->andReturnUsing(function ($customerwithdrawalrequestArgument, $customerwithdrawalrequestDetailsArgument) use ($customerwithdrawalrequest, $transactionDetails) {
                $this->assertEquals($customerwithdrawalrequest, $customerwithdrawalrequestArgument);
                $this->assertEquals($transactionDetails, $customerwithdrawalrequestDetailsArgument);
            });
