...
class CustomerWithdrawalRequestServiceTest extends TestCase
{
    ...
    public function testItCorrectlyInitiatesACustomerWithdrawalRequestRepayment()
    {
        ...
        $this->customerwithdrawalrequestService->shouldReceive('initiateCustomerWithdrawalRequest')
            ->andReturnUsing(function ($ testItThrowsExceptionWhenTryingToOverRepayCustomerWithdrawalRequestArgument, $customerwithdrawalrequestDetailsArgument) use ($customerwithdrawalrequest, $customerwithdrawalrequestDetails) {
