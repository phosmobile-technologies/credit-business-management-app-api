...
class CustomerWithdrawalRequestServiceTest extends TestCase
{
    ...
    public function testItCorrectlyInitiatesACustomerWithdrawalRequestRepayment()
    {
        ...
        $this->transactionService->shouldReceive('initiateCustomerWithdrawalRequest')
            ->andReturnUsing(function ($transactionArgument, $transactionDetailsArgument) use ($customerwithdrawalrequest, $customerwithdrawalrequestDetails) {
                $this->assertEquals($customerwithdrawalrequest, $transactionArgument);
                $this->assertEquals($customerwithdrawalrequestDetails, $transactionDetailsArgument);
            });

        $this->transactionService->initiateCustomerWithdrawalRequestRepayment($customerwithdrawalrequest->id, $customerwithdrawalrequestDetails);
    }
}
